...
TEXT = "This is a region of New York."

logging.basicConfig(level=logging.DEBUG)

try:
    logging.info("Printing text iteratively to the screen")
    epd = epd7in5_V2.EPD()
    ...
    #example 2: loads a bitmap in a rectangle
    ...
    draw.text((400,400), TEXT, font = font24, fill = 0)
